...
pub(crate) fn is_list_like(obj: &Bound<'_, PyAny>, py: Python<'_>) -> PyResult<bool> {
    Ok(obj.is_instance_of::<pyo3::types::PyList>()
        || obj.is_instance(&py.get_type::<crate::list_proxy::ListProxy>())?)
}
